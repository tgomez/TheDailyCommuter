...
function makeResponsive() {
    ...
    d3.csv("data.csv", function(err, six_five_data) {
    if (err) throw err;
    
    six_five_data.forEach(function(data) {
        data.PublicTransportPercent = +data.PublicTransportPercent;
        data.MalePercent = +data.MalePercent;
        data.HomeownerPercent = +data.HomeownerPercent;
        data.PersonalVehiclePercent = +data.PersonalVehiclePercent;
        data.MarriedPercent = +data.MarriedPercent;
        data.TotalCommuteMinutes = +data.TotalCommuteMinutes;
    });
    ...
    var currentAxisLabelX = "MalePercent";
    var currentAxisLabelY = "PublicTransportPercent";
    
    // Call findMinAndMax() with 'MalePercent' as default
    ...
    var toolTip = d3
        ...
        if (currentAxisLabelX === "MalePercent") {
            stringX = "MalePercent: ";
            stringY = "PublicTransportPercent: ";
        }
        else if (currentAxisLabelX === "HomeownerPercent") {
            stringX = "HomeownerPercent: ";
            stringY = "PersonalVehiclePercent: ";
        }
        else {
            stringX = "MarriedPercent: "
            stringY = "TotalCommuteMinutes: ";
        }
        return states +
            "<br>" +
            stringX +
    ...
    chart
        ...
        .attr("dy", "1em")
        .attr("class", "axis-text unchange")
        .attr("data-axis-name", "TotalCommuteMinutes")
        .attr("id", "TotalCommuteMinutes")
        .text("Total Average Commute (Minutes)");
    ...
    chart
        ...
        .attr("data-axis-name", "MalePercent")
        .text("Male(%)");
    ...
    chart
        ...
        .attr("data-axis-name", "HomeownerPercent")
        .text("Homeowner (%)");
    ...
    chart
        ...
        // This axis label is inactive by default
        .attr("class", "axis-text inactive")
        .attr("data-axis-name", "MarriedPercent")
        .text("Married (%)");
    ...
    d3.selectAll(".axis-text").on("click", function() {
        ...
        if (clickedAxis === "MalePercent") {
            ...
            corrAxis = d3.select("#HomeownerPercent");
        }
        else {
            corrAxis = d3.select("#TotalCommuteMinutes");
        }
